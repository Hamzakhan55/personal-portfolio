      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
        ...
        <div className={`flex justify-center lg:justify-end animate-on-scroll-right px-8 order-1 lg:order-2 ${isLoaded ? 'visible' : ''}`} style={{ transitionDelay: '0.4s' }}>
          <div className="relative">
            ...
            <div className="absolute -top-4 -right-12 w-10 h-10 bg-slate-800/80 backdrop-blur-sm rounded-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 border border-slate-600/50">
            ...
            <div className="absolute -bottom-8 -left-6 w-11 h-11 bg-cyan-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center animate-spin border border-cyan-400/30" style={{ animationDuration: '6s' }}>
